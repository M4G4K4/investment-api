...
public class TokenUtils {
    //TODO: Generate with ID of the loged in user
    //TODO: veirify roles of the users when making requests
    //TODO verify userid inside token for example when updating account
